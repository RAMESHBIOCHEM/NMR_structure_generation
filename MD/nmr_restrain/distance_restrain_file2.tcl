...
set outfile [open Distance2.ref w]
##3881
...
set i4 [atomselect top "segname PROA and name CA and resid 32"]
set j4 [atomselect top "segname PROB and name CA and resid 32"]
set Ai4 [$i4 get index]
set Bj4 [$j4 get index]
set bond_AB4 [list $Ai4 $Bj4]

set i5 [atomselect top "segname PROA and name CA and resid 36"]
set j5 [atomselect top "segname PROB and name CA and resid 36"]
set Ai5 [$i5 get index]
set Bj5 [$j5 get index]
set bond_AB5 [list $Ai5 $Bj5]



   # set rlist5 [$PS2 get index]
    puts $outfile "bond $bond_AB1 ZFC 6.0\nbond $bond_AB2 ZFC 6.0\nbond $bond_AB3 ZFC 5.38\nbond $bond_AB4 ZFC 6.0\nbond $bond_AB5 ZFC 6.0"
