...
set outfile [open Dist_VL.ref w]
##3881
...
set i4 [atomselect top "segname PROA and name CA and resid 18"]
set j4 [atomselect top "segname PROB and name CA and resid 17"]
set Ai4 [$i4 get index]
set Bj4 [$j4 get index]
set bond_AB4 [list $Ai4 $Bj4]

set i5 [atomselect top "segname PROA and name CA and resid 29"]
set j5 [atomselect top "segname PROB and name CA and resid 28"]
